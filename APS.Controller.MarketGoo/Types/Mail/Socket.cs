...
namespace APS.CSharp.Test.Types.Mail
{
    ...
    public struct Socket
    {
        ...
        /// <summary>
        /// Port number. 
        /// If this property is omitted, the protocol’s default value for the specified encryption must be used. 
        /// For example: 143 for IMAP without encryption, 993 for IMAP with SSL encryption.
        /// </summary>
        ...
        /// <summary>
        /// Encryption type that is used for data transferring. 
        /// The possible values: 
        /// None, SSL, any string. 
        /// 
